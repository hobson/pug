...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Field.most_frequent'
        db.delete_column(u'miner_field', 'most_frequent')


        # Changing field 'AggregatedResults.name'
        db.alter_column(u'miner_aggregatedresults', 'name', self.gf('django.db.models.fields.CharField')(max_length=2000))

        # Changing field 'AggregatedResults.slug'
        db.alter_column(u'miner_aggregatedresults', 'slug', self.gf('django.db.models.fields.CharField')(max_length=2000))

        # Changing field 'AggregatedResults.uri'
        db.alter_column(u'miner_aggregatedresults', 'uri', self.gf('django.db.models.fields.CharField')(max_length=2000))

    def backwards(self, orm):
        # Adding field 'Field.most_frequent'
        db.add_column(u'miner_field', 'most_frequent',
                      self.gf(u'django_hstore.fields.DictionaryField')(default=None, null=True, db_index=True),
                      keep_default=False)


        # Changing field 'AggregatedResults.name'
        db.alter_column(u'miner_aggregatedresults', 'name', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'AggregatedResults.slug'
        db.alter_column(u'miner_aggregatedresults', 'slug', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'AggregatedResults.uri'
        db.alter_column(u'miner_aggregatedresults', 'slug', self.gf('django.db.models.fields.CharField')(max_length=256))

    models = {
        u'miner.aggregatedresults': {
            'Meta': {'object_name': 'AggregatedResults'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'exclude_dict': ('jsonfield.fields.JSONField', [], {}),
            'filter_dict': ('jsonfield.fields.JSONField', [], {}),
            'get_dict': ('jsonfield.fields.JSONField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '2000'}),
            'results': ('jsonfield.fields.JSONField', [], {}),
            'slug': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '2000'}),
