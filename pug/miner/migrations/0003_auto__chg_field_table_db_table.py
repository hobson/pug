...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Table.db_table'
        db.alter_column(u'miner_table', 'db_table', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):

        # Changing field 'Table.db_table'
        db.alter_column(u'miner_table', 'db_table', self.gf('django.db.models.fields.CharField')(default='', max_length=256))
