...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'miner_aggregatedresults', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=256)),
            ('slug', self.gf('django.db.models.fields.CharField')(default='', max_length=256)),
            ('uri', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('get_dict', self.gf('jsonfield.fields.JSONField')()),
            ('filter_dict', self.gf('jsonfield.fields.JSONField')()),
            ('exclude_dict', self.gf('jsonfield.fields.JSONField')()),
            ('results', self.gf('jsonfield.fields.JSONField')()),
        ))
        db.send_create_signal(u'miner', ['AggregatedResults'])


    def backwards(self, orm):
        # Deleting model 'AggregatedResults'
        db.delete_table(u'miner_aggregatedresults')
    ...
    models = {
        u'miner.aggregatedresults': {
            ...
            'slug': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '256'}),
