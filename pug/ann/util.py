...
def plot_trainer(trainer, mean=0, std=1, title='', show=True, save=True):
...
def sim_network(network, ds=None, mean=0, std=1):
    ...
    return pd.DataFrame(results_generator, columns=['Output', 'Target'])